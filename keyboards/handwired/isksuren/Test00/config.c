...
#define VENDOR_ID       0x6A6A  // CDG9K
#define PRODUCT_ID      0x1010  // Isks01
#define DEVICE_VER      0x0001
#define MANUFACTURER    Condog9000
#define PRODUCT         Isksuren
#define DESCRIPTION     Handwired 96ish

/* key matrix */
#define MATRIX_ROWS 12
#define MATRIX_COLS 10

#define MATRIX_ROW_PINS { B7, B6, B5, B4, B3, B2, B1, B0, A4, A5, A6, A7, }
#define MATRIX_COL_PINS { A8, A15, A13, A14, B12, B11, B10, B9, B15, B14 }
#define UNUSED_PINS
